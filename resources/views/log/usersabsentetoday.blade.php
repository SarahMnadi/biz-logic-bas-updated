            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('usersAbsenteToday', Auth::user()->user_id) }}">users not present today</a></li>
                    </ol>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Users Not Present Today</h3>
                            ...
                            <tbody>
                                ...
                                @foreach ($logs as $log)
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 10%">{{ date('Y:m:d')}}
                                        </td>
                                        <td style="width: 15%">
                                           -
                                        </td>
                                       
                                        <td style="width: 10%"><span class="badge bg-danger">not-present</span>
